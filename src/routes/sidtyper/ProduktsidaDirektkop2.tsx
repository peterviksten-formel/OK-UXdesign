...
/**
 * SIDTYP 10b, Produktsida direktköp v2 (sticky-bottom)
 *
 * Variant av Direktköp där sticky-kolumnen till höger är ersatt med en
 * sticky bottom-bar som visas på alla viewports. Hero + alla content-block
 * får full bredd istället för 2-col grid.
 *
 * UX-rationale (Spool/Krug): direktköp är transaktionellt, användaren har
 * bestämt sig och behöver bara nå commit. Bottom-bar är ett etablerat
 * e-com-pattern (Klarna, Ikea, Apple Store) och ger:
 *  - Alltid synlig CTA utan att stjäla content-yta
 *  - Mindre visuellt brus än sidekolumn
 *  - Identisk pattern på desktop + mobil (bryter inte konsekvensen)
 *
 * Auto-hider sig automatiskt när formulär-sektionen är i viewport
 * (samma IntersectionObserver-logik som original-varianten på mobil).
 *
 * UX-principer:
...
export function ProduktsidaDirektkop2() {
  ...
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6">
      ...
      {/* Full-bredd layout. Inga 2-col grid eller sticky-sidebar,
          istället sticky-bottom-bar (alltid synlig på desktop+mobil) som
          äger 'Beställ'-handlingen. Auto-hider när formuläret är i

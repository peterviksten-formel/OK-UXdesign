...
export function ProduktsidaLeadsgen() {
  ...
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6">
            ...
            <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-8 lg:mt-2">
              ...
              <div className="hidden lg:block pt-8 sm:pt-12">
                <StickyPurchaseSidebar
                  ...
                  subtitle="Ingen säljpress · vi ringer inom 2 dagar"
                  ctaLabel="Boka rådgivning"
                  ctaHref="#lead-form"
                  reassurance={[
                    "Kostnadsfri besiktning på plats",
                    "Skriftlig offert med exakta siffror",
                    "Du bestämmer själv när och om",
                  ]}
                  saljare={{
                    initialer: "AL",
                    namn: "Anna Lindqvist",
                    roll: "Solrådgivare, 8 års erfarenhet",
                  }}
                  hideWhenSelector="#lead-form"
                />
              </div>
            </div>

            {formAndAfter.length > 0 && (
              <BlockList pageId="produktsida-leadsgen" blocks={formAndAfter} />
            )}
          </>
        );
      })()}
      ...
      <StickyPurchaseBottomBar
        eyebrow="Solceller"
        title="Boka kostnadsfri rådgivning"
        subtitle="Vi ringer inom 2 dagar"
        ctaLabel="Boka"
        ctaHref="#lead-form"
        hideWhenSelector="#lead-form"
      />
